      ...
      <div className=" h-4/5">
        ...
        <div className="flex  justify-center ">
          <input
            ...
            onClick={() => setNum(1)}
            type="radio"
            className="z-20   absolute bottom-24 mr-48"
          />
          <input
            name="vid"
            onClick={() => setNum(2)}
            type="radio"
            className="z-20   absolute bottom-24 mr-36"
          />
          <input
            name="vid"
            onClick={() => setNum(3)}
            type="radio"
            className="z-20   absolute bottom-24 mr-24"
          />
          <input
            name="vid"
            onClick={() => setNum(4)}
            type="radio"
            className="z-20   absolute bottom-24 mr-12"
          />
          <input
            name="vid"
            onClick={() => setNum(5)}
            type="radio"
            className="z-20   absolute bottom-24 "
          />
        </div>
        <div className="flex flex-col justify-center items-center h-4/5 px-8">
        <h2 className=" text-6xl pb-4 text-center text-white top-2/4 font-bold">We make dreams come true!!</h2>
        ...
        <button className="bg-green-500  rounded-md text-white text-lg mt-4 py-2 px-2">Discover More </button>
        </div>
      </div>
    </section>
  );
